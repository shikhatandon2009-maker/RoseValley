  ...
  try {
    ...
    if (error || !theme) {
      return NextResponse.json({
        ...
        font_weight_mode: memoryThemeCache.font_weight_mode || 'thin',
    ...
    return NextResponse.json({
      ...
      font_weight_mode: theme.font_weight_mode || memoryThemeCache.font_weight_mode || 'thin',
