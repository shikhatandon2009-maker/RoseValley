...
import { Droplet, Sparkles, ShieldCheck, ArrowRight, CheckCircle2, Leaf, Globe, FlaskConical, Crown, Users, BookOpen, ExternalLink, Flame, History } from 'lucide-react';
...
export const metadata = {
  title: 'About RoseOil.in | 100% Pure Botanical Distillation',
  description: 'Discover RoseOil.in, dedicated to producing 100% pure, natural essential oils and therapeutic botanical hydro-distillates.',
};
    ...
    <div className="min-h-screen bg-[#F7EEED] text-[#1A0510] font-sans selection:bg-[#F6A6BB] selection:text-neutral-950 overflow-x-hidden relative">
      ...
      <section className="relative py-20 sm:py-32 overflow-hidden border-b border-[#F7D1D8] bg-gradient-to-b from-[#FAE6E7] via-[#F7EEED] to-[#F7EEED]">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center space-y-5 sm:space-y-6">
          ...
          {/* Trust & Botanical Subheading Pill */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/70 backdrop-blur-md border border-[#F7D1D8] text-[#4A0D25] text-[11px] sm:text-xs font-semibold uppercase tracking-widest shadow-xs">
            <Crown className="w-3.5 h-3.5 text-[#D45A7A]" /> 100% Pure Botanical Essential Oils
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg text-[#4A0D25]/90 max-w-2xl mx-auto leading-relaxed font-normal">
            RoseOil.in is a premier purveyor of 100% pure, therapeutic-grade botanical essential oils, steam distillates, and rare aromatic extracts.
          </p>
          ...
          <div className="flex items-center justify-center gap-3.5 sm:gap-4 pt-3 flex-wrap">
            <Link
              href="/products"
              className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full bg-[#4A0D25] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#1A0510] transition-all shadow-md hover:shadow-lg hover:scale-[1.02]"
            >
              Explore Collection <ArrowRight className="w-4 h-4 text-[#F6A6BB]" />
            </Link>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full bg-white/90 backdrop-blur-xs border border-[#F7D1D8] text-[#1A0510] font-bold text-xs uppercase tracking-widest hover:bg-[#FAE6E7] transition-all shadow-xs"
            >
              Contact Specialists
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center">
            ...
            <div className="space-y-2 p-5 sm:p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 shadow-sm hover:border-[#F6A6BB]/50 hover:bg-white/10 transition-all">
              <div className="font-serif font-light text-4xl sm:text-5xl text-[#FFF5F7] tracking-tight drop-shadow-[0_2px_12px_rgba(246,166,187,0.3)]">
                <AnimatedCounter end={100} suffix="%" duration={1400} className="text-[#FFF5F7] font-serif font-light text-4xl sm:text-5xl" />
              </div>
              <div className="text-[11px] sm:text-xs text-[#F6A6BB] font-bold uppercase tracking-wider">Pure & Undiluted</div>
              <div className="text-[11px] text-white/60 font-light">Zero synthetic fillers or alcohol</div>
            </div>
            ...
            <div className="space-y-2 p-5 sm:p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 shadow-sm hover:border-[#F6A6BB]/50 hover:bg-white/10 transition-all">
              ...
              <div className="text-[11px] text-white/60 font-light">Global boutique distribution</div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-5 text-left order-2 lg:order-1">
            <div className="inline-flex items-center gap-1.5 text-xs font-mono font-bold text-[#9A2048] uppercase tracking-widest">
              <Flame className="w-4 h-4 text-[#D45A7A]" /> Artisanal Steam Distillation
            </div>
            ...
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-light tracking-tight text-[#1A0510] leading-[1.05]">
              ...
              <span className="block font-normal text-[#4A0D25]">
                Pure Hydro-Distillation
              </span>
            </h2>

            <p className="text-sm sm:text-base text-[#4A0D25]/90 leading-relaxed font-normal">
              Every season, millions of fresh <em>Rosa Damascena</em> blossoms are harvested before sunrise, while their natural aromatic dew remains undisturbed.
            </p>

            <p className="text-sm sm:text-base text-[#4A0D25]/90 leading-relaxed font-normal">
              Distilled with pure water and gentle heat, the fragrant vapors are carefully condensed to capture the delicate, therapeutic essence of the plant.
            </p>
            ...
            <div className="grid grid-cols-2 gap-3.5 pt-3">
              <div className="p-4 rounded-2xl bg-white/90 border border-[#F7D1D8] shadow-xs space-y-1">
                <span className="text-[10px] text-[#9A2048] font-bold uppercase tracking-widest block">Extraction Cycle</span>
                <p className="font-serif font-bold text-lg text-[#1A0510]">Slow Extraction</p>
              ...
              <div className="p-4 rounded-2xl bg-white/90 border border-[#F7D1D8] shadow-xs space-y-1">
                ...
                <p className="text-[11px] text-[#4A0D25]/75">Skin-nourishing & therapeutic</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative aspect-[4/3] w-full rounded-3xl overflow-hidden shadow-2xl border-2 border-[#F7D1D8] group order-1 lg:order-2">
            <Image
              ...
              alt="Artisanal Botanical Distillation"
              fill
              priority
            ...
            <div className="absolute bottom-6 left-6 right-6 text-white space-y-1.5">
              ...
              <p className="font-serif font-light text-xl text-white">Artisanal Hydro-Extraction</p>
              <p className="text-xs text-stone-200/90 font-light">Natural steam and copper hydro-distillation capturing plant essences</p>
            </div>
          </div>
      ...
      {/* BOTANICAL DISTILLATION PROCESS */}
      <SectionWrapper className="bg-white/60 border-y border-[#F7D1D8] py-16 sm:py-24 relative">
        <div className="text-center space-y-3 mb-14 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#FAE6E7] border border-[#F7D1D8] text-[#4A0D25] text-xs font-bold uppercase tracking-widest">
            <History className="w-3.5 h-3.5 text-[#D45A7A]" /> Our Distillation Process
          </div>
          <h2 className="font-serif text-3xl sm:text-5xl font-light tracking-tight text-[#1A0510]">
            From Soil to Pure Extract
          </h2>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-4">
            {[
              { year: 'Step 1', title: 'Dawn Harvesting', desc: 'Hand-harvesting fresh petals and botanical roots at peak aroma potency', icon: Leaf },
              { year: 'Step 2', title: 'Hydro-Distillation', desc: 'Gentle steam extraction using pure mountain artesian water', icon: FlaskConical },
              { year: 'Step 3', title: 'Cold Condensation', desc: 'Slow condensation preserving delicate aromatherapeutic compounds', icon: Droplet },
              { year: 'Step 4', title: 'GC-MS Testing', desc: 'Rigorous gas chromatography testing verifying 100% purity', icon: ShieldCheck },
            ].map((milestone, idx) => {
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-5">
            {[
              ...
              { title: 'Export Certified', desc: 'Registered for international distribution', icon: Globe },
              { title: 'Lab Verified', desc: 'Certificate of Analysis (COA) provided', icon: BookOpen },
              { title: '100% Natural', desc: 'Pure plant-derived essential oils', icon: Droplet },
            ].map((cert, idx) => {
      ...
      <section className="py-20 sm:py-24 bg-gradient-to-br from-[#4A0D25] via-[#3D081E] to-[#1A0510] text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 relative z-10 space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/15 text-[#FFF5F7] text-xs font-bold uppercase tracking-widest">
            <Sparkles className="w-3.5 h-3.5 text-[#F6A6BB]" /> Begin Your Botanical Journey
          </div>
          
          <h2 className="font-serif text-3xl sm:text-5xl font-light text-white leading-tight">
            Experience 100% Pure Botanical Essential Oils
          </h2>
          
          <p className="text-sm sm:text-base text-white/75 font-normal max-w-xl mx-auto leading-relaxed">
            Immerse yourself in our collection of pure essential oils, botanical distillates, and therapeutic essences — crafted with uncompromising purity at RoseOil.in.
          </p>
