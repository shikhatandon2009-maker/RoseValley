...
const CATALOGUE: HeroItem[] = [
  {
    id: 'h1',
    name: 'Gulab Khas',
    house: "MAISON DE L'ESSENCE",
    year: 'Est. 1620 · Kannauj',
    story: 'Twelve thousand kilograms of pre-dawn Damask petals captured in a single copper still — this is living perfumery.',
    accord: ['Damask Rose', 'Copper Deg-Bhapka', 'Morning Dew', 'Sacred Sandalwood'],
  ...
  },
  {
    ...
    accord: ['Aged Oud', 'Kashmiri Saffron', 'Rose', '40 Botanicals'],
    slug: 'shamama-kannauj-attar',
    image: '/images/hero/champaca-bottle.png',
    price: 3900,
    volume: '12ml Concentrated Oil',
    badge: 'Rare Seasonal Batch',
  },
];

const TICKER = [
  'DAMASK ROSE', '·', 'RUH GULAB', '·', 'WILD VETIVER', '·', 'MYSORE SANDALWOOD',
  '·', 'KASHMIRI SAFFRON', '·', 'SHAMAMA ATTAR', '·', 'DEG-BHAPKA STEAM', '·',
  'COPPER DISTILLATION', '·', 'ALCOHOL-FREE', '·', 'COA CERTIFIED', '·',
  '400 YEARS', '·', 'KANNAUJ HERITAGE', '·',
];
